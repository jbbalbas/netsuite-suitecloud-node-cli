...
import Script from './resources/types/Javascript';
import AbstractExtension from './AbstractExtension';

export default class Extension extends AbstractExtension {
	PREFIX: any;
	rawExtension: any;
	basePath: any;
	vendor: any;
	...
	getJavascript() {
		...
		Object.entries({ javascriptApp, javascriptEntrypoints }).forEach(([key, resources]) => {
			this.iterateResources(resources, (resourcePath: string, app: any) => {
