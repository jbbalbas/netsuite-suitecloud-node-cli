...
import AssetsCompiler from '@oracle/suitecloud-cli-localserver-command/src/compilers/AssetsCompiler';

import { SERVERPATH, CUSTOM_ASSETS_PATH, removeFolder, mockClearConsoleLog, createLocalserverFolder } from './helpers';
