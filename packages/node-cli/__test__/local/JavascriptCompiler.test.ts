...
import JavascriptCompiler from '@oracle/suitecloud-cli-localserver-command/src/compilers/JavascriptCompiler';

import { SERVERPATH, removeFolder, createLocalserverFolder, mockClearConsoleLog } from './helpers';
...
const Script = jest.fn(function(options = { src: '', dst: '', applications, isEntrypoint: false }) {
